...
<head>
    ...
    <!-- Script Usuarios -->
    <script src="Js/nacionalidad/nac.js"></script>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Configuracion parametro nacionalidad</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header bg-info">
                                        <h4 class="modal-title">Actualización de Nacionalidad</h4>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <form method="POST" id="formunac" name="formulariopre" role="form" enctype="multipart/form-data" class="needs-validation" novalida>
                                                    <div class="">
                                                        ...
                                                        <input type="hidden" name="ID" id="ID" autocomplete="off" class="form-control input-sm" placeholder="Nacionalidad">
                                                        <input type="text" name="nacio" id="nacio" autocomplete="off" class="form-control input-sm" placeholder="Nacionalidad">
                                            ...
                                            <div class="modal-footer justify-content-end">
                                                ...
                                                <button type="submit" class="btn btn-info" data-dismiss="modal" id="submit12" onclick="actualizar_nac()" value=" enviar">
                                                    Guardar
                                                </button>
                                            </div>
                                            </form>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="modal fade" id="nac1">
                                    <div class="modal-dialog modal-lg">

                                        <div class="modal-content">
                                            <div class="modal-header bg-info">
                                                <h4 class="modal-title">Añadir nacionalidad</h4>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <form method="POST" id="formunacion" name="formulariopre" role="form" enctype="multipart/form-data" class="needs-validation" novalida>
                                                            <div class="">
                                                                <label>Nacionalidad</label>
                                                                <input type="text" name="nac" id="nac" autocomplete="off" class="form-control input-sm" placeholder="Nacionalidad">
                                                    ...
                                                    <div class="modal-footer justify-content-end">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">cerrar</button>
                                                        <button type="submit" class="btn btn-info" data-dismiss="modal" id="submit12" onclick="nuevonac()" value=" enviar">
                                                            Guardar
                                                        </button>
                                                    </div>
                                                    </form>
