  ...
  (V.cleanData =
    ...
    (V.widget = function (t, i, e) {
      ...
      return (
        ...
        (V.expr.pseudos[h.toLowerCase()] = function (t) {
          return !!V.data(t, h);
        }),
        (V[r] = V[r] || {}),
        (s = V[r][t]),
  ...
  V.widget("ui.droppable", {
    ...
    (V.ui.intersect = function (t, e, i, s) {
      ...
      switch (i) {
        ...
        case "pointer":
          return (
            g(s.pageY, l, e.proportions().height) &&
            g(s.pageX, h, e.proportions().width)
          );
        case "touch":
          return (
        ...
        for (
          t.drawMonth = K,
            ...
            R = F
              ? this.formatDate(
                  R,
                  this._daylightSavingAdjust(new Date(U, K - O, 1)),
            ...
            W = this._get(t, "gotoCurrent") && t.currentDay ? B : A,
            O = F ? this.formatDate(O, W, this._getFormatConfig(t)) : O,
            R = "",
            t.inline ||
              (R = V("<button>")
                .attr({
          ...
          for (_ = "", this.maxRows = 4, v = 0; v < L[1]; v++) {
            ...
            for (
              w += x + "</tr></thead><tbody>",
                ...
                this.maxRows = I,
                P = this._daylightSavingAdjust(new Date(U, K, 1 - C)),
                T = 0;
              T < I;
              T++
            ) {
              for (
                ...
                (S = c ? c.apply(t.input ? t.input[0] : null, [P]) : [!0, ""]),
                  (z =
                    ((H = P.getMonth() !== K) && !d) ||
                    !S[0] ||
                    (j && P < j) ||
                  ...
                  (M +=
                    ...
                    ((P.getTime() === b.getTime() &&
                      K === t.selectedMonth &&
                      t._keyEvent) ||
                    (p.getTime() === P.getTime() && p.getTime() === b.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (z
                    ...
                    (H && !u
                      ...
                      : "<a class='ui-state-default" +
                        ...
                        "' href='#' aria-current='" +
                        (P.getTime() === B.getTime() ? "true" : "false") +
                        "' data-date='" +
                        P.getDate() +
                        "'>" +
                        P.getDate() +
          ...
          ? this.handles.each(function (t) {
              (i =
                ...
                (l["horizontal" === r.orientation ? "left" : "bottom"] =
                  i + "%"),
                V(this).stop(1, 1)[h ? "animate" : "css"](l, a.animate),
                !0 === r.options.range &&
