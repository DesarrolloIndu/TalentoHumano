    ...
    <div class="col-md-12">
      <div class="card ccard radius-t-0 h-100">
        ...
        <div class="card-header pb-3 brc-secondary-l3">
          <h5 class="card-title mb-2 mb-md-0 text-dark-m3"></h5>
        </div>
        <?php
        $result = mysqli_query($conn, "call Sp_Select_Dashboard()");
        ...
        <div class="container">
            <div class="card-body pt-2 pb-1 ">
              <div role="button" class="col   d-flex flex-wrap align-items-center my-2 bgc-secondary-l4 bgc-h-secondary-l3 radius-1 p-25 d-style" onclick="Datos_Seguimiento('<?php echo $datos; ?>');">
...
<script src="Js/Dashboard/Seguimiento.js"></script>