...
<section>
    <div class="table-responsive">
        <table id="Tabla_cargo" class="table table-hover table-condensed  table-striped" style="width: 100%;">
            <caption>
                <button class="btn btn-info" data-toggle="modal" data-target="#cargomodal" id="New">
                    Agregar cargo
            ...
            <tbody>
                ...
                $result = mysqli_query($conn, "call cargo_Full;");
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class='btn btn-danger a' href="Php/Cargos/reprotecargo.php?id=<?php echo $var ?>"><i class="fa fa-file-pdf">
